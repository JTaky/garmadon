...
public class ProtoParquetWriterWithOffset<MESSAGE_KIND extends MessageOrBuilder>
    ...
    public Path close() throws IOException {
        ...
        Gauge.Child latestCommittedTimestampGauge = PrometheusMetrics.latestCommittedTimestampGauge(eventName, latestOffset.getPartition());
        latestCommittedTimestampGauge.set(Double.max(latestCommittedTimestampGauge.get(), latestTimestamp));
